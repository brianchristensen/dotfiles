...
## iTerm2 and ZSH
I use ZSH instead of bash in both iTerm and in VSC Integrated Terminal.  I manage it with Oh-My-Zsh sh -c "$(curl -fsSL https://raw.githubusercontent.com/robbyrussell/oh-my-zsh/master/tools/install.sh)"
